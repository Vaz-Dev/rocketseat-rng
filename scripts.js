...
const rng = {
    ...
    async roll() {
        if (0 == this.rolls++) {
            this.max = Number(numberMax.value)
            this.min = Number(numberMin.value)
            this.quantity = Number(numberQuantity.value)
